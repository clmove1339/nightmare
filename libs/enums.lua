netvars = {
    ...
    m_flSimulationTime        = engine.get_netvar_offset('DT_BaseEntity', 'm_flSimulationTime'),
    m_nExplodeEffectTickBegin = engine.get_netvar_offset('DT_BaseCSGrenadeProjectile', 'm_nExplodeEffectTickBegin'),
